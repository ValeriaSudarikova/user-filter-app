...
5. Расширьте данные о каждом пользователе, добавив поле для URL изображения или возможность загрузки файла с фотографией.
6. Визуально отобразите фотографию пользователя рядом с его данными.
7. Реализуйте функционал, который позволит пользователю загрузить фотографию для каждого пользователя.
8. Убедитесь, что фотографии корректно отображаются на странице и сохраняются вместе с данными пользователя.)
